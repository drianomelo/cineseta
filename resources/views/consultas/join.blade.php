...
@section('content')
    <div class="flex flex-col items-center justify-center gap-4 p-4">
        ...
        <div class="flex flex-col w-[600px] items-center p-6 border-4 border-gray-800 rounded-2xl">
            <h2 class="font-semibold text-yellow-400">Consulta usando um JOIN
            </h2>
            <form class="flex flex-col items-center justify-center gap-2 mt-1 mb-4" action="{{ route('consultas.join') }}"
                method="GET" name="join" id="join">
                <input
                ...
                <button
                    ...
                    type="button" onclick="submitForm('join')">CONSULTAR</button>
            </form>
        </div>
